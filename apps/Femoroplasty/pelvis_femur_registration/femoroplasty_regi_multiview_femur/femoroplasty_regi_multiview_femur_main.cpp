...
int main(int argc, char* argv[])
{
  ...
  regi.ref_frames = { femur_multiview_regi_ref_frame };
  ...
  {
    regi.init_cam_to_vols = { init_cam_to_femur * init_device_cam_to_vols.inverse() };
...

    {
      ...
      lvl_regi_coarse.static_vol_poses = { };
    ...
    if (kSAVE_REGI_DEBUG )
    {
      ...
      regi.debug_info->regi_names = { { "Multiview Femur"} };
    }
    ...
    WriteITKAffineTransform(output_path + "/femur_regi_xform_default.h5", regi.cur_cam_to_vols[0] * init_device_cam_to_vols);
